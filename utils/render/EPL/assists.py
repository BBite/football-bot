...
def render_assists(assists: list, lang: str):
    ...
    if lang == 'en':
        back_g = Image.open('C:/mpr/football_bot/utils/render/EPL/bg/assists/EPL_en.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/EPL/bg/assists/EPL_ru.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/EPL/bg/assists/EPL_ua.jpg')
        logos = {
    ...
    back_g.save(rf'C:\mpr\football_bot\data\assists\epl_{lang}.jpg')
