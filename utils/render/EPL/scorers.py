...
def render_scorers(scorers: list, lang: str):
    ...
    if lang == 'en':
        goal_pos = 864
        back_g = Image.open('C:/mpr/football_bot/utils/render/EPL/bg/scorers/EPL_en.jpg')
        logos = {
        ...
        goal_pos = 871
        back_g = Image.open('C:/mpr/football_bot/utils/render/EPL/bg/scorers/EPL_ru.jpg')
        logos = {
        ...
        goal_pos = 873
        back_g = Image.open('C:/mpr/football_bot/utils/render/EPL/bg/scorers/EPL_ua.jpg')
        logos = {
    ...
    back_g.save(rf'C:\mpr\football_bot\data\scorers\epl_{lang}.jpg')
