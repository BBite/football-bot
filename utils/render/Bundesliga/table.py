...
def render_table(teams: list, lang: str):
    ...
    if lang == 'en':
        back_g = Image.open('C:/mpr/football_bot/utils/render/Bundesliga/bg/table/Bundesliga_en.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/Bundesliga/bg/table/Bundesliga_ru.jpg')
        logos = {
        ...
        back_g = Image.open(r'C:/mpr/football_bot/utils/render/Bundesliga/bg/table/Bundesliga_ua.jpg')
        logos = {
    ...
    back_g.save(rf'C:\mpr\football_bot\data\tables\b_{lang}.jpg')
