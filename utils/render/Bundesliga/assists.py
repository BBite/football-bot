...
def render_assists(assists: list, lang: str):
    ...
    if lang == 'en':
        back_g = Image.open('C:/mpr/football-bot/utils/render/Bundesliga/bg/assists/Bundesliga_en.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football-bot/utils/render/Bundesliga/bg/assists/Bundesliga_ru.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football-bot/utils/render/Bundesliga/bg/assists/Bundesliga_ua.jpg')
        logos = {
    ...
    back_g.save(rf'C:\mpr\football-bot\data\assists\b_{lang}.jpg')
