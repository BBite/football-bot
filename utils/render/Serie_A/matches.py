...
def render_matches(matches: list, lang: str):
    back_g = Image.open(r'C:/mpr/football-bot/utils/render/Serie_A/bg/matches/Next matches SerieA.jpg')
    ...
    if lang == 'en':
        ...
        logos = {
            ...
            'Internazionale': r'C:/mpr/football-bot/utils/render/Serie_A/logo/Inter.png',
    ...
    back_g.save(rf'C:\mpr\football-bot\data\matches\sa_{lang}.jpg')
