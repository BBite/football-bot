...
def render_table(teams: list, lang: str):
    ...
    if lang == 'en':
        back_g = Image.open('C:/mpr/football_bot/utils/render/Serie_A/bg/table/SerieA_en.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/Serie_A/bg/table/SerieA_ru.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/Serie_A/bg/table/SerieA_ua.jpg')
        logos = {
    ...
    back_g.save(rf'C:\mpr\football_bot\data\tables\sa_{lang}.jpg')
