...
def render_assists(assists: list, lang: str):
    ...
    if lang == 'en':
        goal_pos = 864
        back_g = Image.open('C:/mpr/football-bot/utils/render/UPL/bg/assists/UPL_en.jpg')
        logos = {
        ...
        goal_pos = 871
        back_g = Image.open('C:/mpr/football-bot/utils/render/UPL/bg/assists/UPL_ru.jpg')
        logos = {
        ...
        goal_pos = 873
        back_g = Image.open('C:/mpr/football-bot/utils/render/UPL/bg/assists/UPL_ua.jpg')
        logos = {
            'Динамо': r'C:/mpr/football-bot/utils/render/UPL/logo/Dynamo.png',
    ...
    back_g.save(rf'C:\mpr\football-bot\data\assists\upl_{lang}.jpg')
