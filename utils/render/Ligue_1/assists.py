...
def render_assists(assists: list, lang: str):
    ...
    if lang == 'en':
        back_g = Image.open('C:/mpr/football-bot/utils/render/Ligue_1/bg/assists/Ligue 1_en.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football-bot/utils/render/Ligue_1/bg/assists/Ligue 1_ru.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football-bot/utils/render/Ligue_1/bg/assists/Ligue 1_ua.jpg')
        logos = {
            'ПСЖ': r'C:/mpr/football-bot/utils/render/Ligue_1/logo/PSG.png',
    ...
    back_g.save(rf'C:\mpr\football-bot\data\assists\l1_{lang}.jpg')
