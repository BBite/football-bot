...
def render_scorers(scorers: list, lang: str):
    ...
    if lang == 'en':
        goal_pos = 864
        back_g = Image.open('C:/mpr/football_bot/utils/render/Ligue_1/bg/scorers/Ligue 1_en.jpg')
        logos = {
        ...
        goal_pos = 871
        back_g = Image.open('C:/mpr/football_bot/utils/render/Ligue_1/bg/scorers/Ligue 1_ru.jpg')
        logos = {
        ...
        goal_pos = 873
        back_g = Image.open('C:/mpr/football_bot/utils/render/Ligue_1/bg/scorers/Ligue 1_ua.jpg')
        logos = {
            'ПСЖ': r'C:/mpr/football_bot/utils/render/Ligue_1/logo/PSG.png',
    ...
    back_g.save(rf'C:\mpr\football_bot\data\scorers\l1_{lang}.jpg')
