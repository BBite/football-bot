...
def render_matches(matches: list, lang: str):
    back_g = Image.open(r'C:/mpr/football-bot/utils/render/Ligue_1/bg/matches/Next matches Ligue1.jpg')
    ...
    back_g.save(rf'C:\mpr\football-bot\data\matches\l1_{lang}.jpg')
