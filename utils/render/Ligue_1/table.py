...
def render_table(teams: list, lang: str):
    ...
    open(r'C:/mpr/football_bot/utils/render/Ligue_1/logo/Strasbourg Alsace.png')

    if lang == 'en':
        back_g = Image.open('C:/mpr/football_bot/utils/render/Ligue_1/bg/table/Ligue1_en.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/Ligue_1/bg/table/Ligue1_ru.jpg')
        logos = {
        ...
        back_g = Image.open('C:/mpr/football_bot/utils/render/Ligue_1/bg/table/Ligue1_ua.jpg')
        logos = {
            'ПСЖ': r'C:/mpr/football_bot/utils/render/Ligue_1/logo/PSG.png',
    ...
    back_g.save(rf'C:\mpr\football_bot\data\tables\l1_{lang}.jpg')
